...
* [`src/cljs/dragdrop/`](src/cljs/dragdrop/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/cljs/dragdrop/core.cljs): contains the SPA entry point, `init`
...
7. Clone this repo and open a terminal in the `dragdrop` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/dragdrop/config.cljs) defaults to `true` in
...
```clj
(ns dragdrop.example
  (:require [dragdrop.config :as config])
